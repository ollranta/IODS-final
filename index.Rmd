...
I could have maybe scale the crime variable on a different way but it showed the right things so maybe that was not necessary. I did not find anything spectacular with my analysis but my hypothesis about the median house value and the amount of crime is right. Maybe this is a non-brainer but at least now I have a linear graph showing the linearity. 
